        ...
        <div class="row mb-4">
            <div class="col-md-10 col-lg-8 col-md-offset-1 col-lg-offset-2">
                ...
                <div class="mb-1 text-content text-secondary">
                    <p>Якщо ви завітали до Львова на довший час, то майте на увазі, що існують різноманітні комбінації проїздних карток терміном на місяць чи більше
                        <br><br>Увага! Львів став першим містом в Україні, де запроваджено безготівкову систему розрахунку в електротранспорті міста. З 16 лютого 2017 р. у всіх львівських трамваях та тролейбусах, пасажири матимуть змогу оплатити проїзд через спеціальний QR код – електронну програму для купівлі та компостирування квитка, яку ініціювали та розробили ЛКП «Львівелектротранс» у співпраці із «Приватбанк».</p>
                </div>
                <div>
            ...
            <div class="row">
                <div class="col-xs-6 col-sm-3">
                    <a href="https://travel-assets.devqub.com/page-your-lviv.html#" class="card card--sq">
                        <div class="card__img">
                            <img src="{{asset('images/bottom_info_img/card-coloured-image-1.jpg')}}" data-lg="images/card-coloured-image-1.jpg" data-md="images/card-coloured-image-1.jpg" data-sm="images/card-coloured-image-1.jpg" alt="" class="blurryload">
                        </div>
                ...
                <div class="col-xs-6 col-sm-3">
                    <a href="https://travel-assets.devqub.com/page-your-lviv.html#" class="card card--sq">
                        <div class="card__img">
                            <img src="{{asset('images/bottom_info_img/card-coloured-image-2.jpg')}}" data-lg="images/card-coloured-image-2.jpg" data-md="images/card-coloured-image-2.jpg" data-sm="images/card-coloured-image-2.jpg" alt="" class="blurryload">
                        </div>
                ...
                <div class="col-xs-6 col-sm-3">
                    <a href="https://travel-assets.devqub.com/page-your-lviv.html#" class="card card--sq">
                        <div class="card__img">
                            <img src="{{asset('images/bottom_info_img/card-coloured-image-3.jpg')}}" data-lg="images/card-coloured-image-3.jpg" data-md="images/card-coloured-image-3.jpg" data-sm="images/card-coloured-image-3.jpg" alt="" class="blurryload">
                        </div>
                ...
                <div class="col-xs-6 col-sm-3">
                    <a href="https://travel-assets.devqub.com/page-your-lviv.html#" class="card card--sq">
                        <div class="card__img">
                            <img src="{{asset('images/bottom_info_img/card-coloured-image-4.jpg')}}" data-lg="images/card-coloured-image-4.jpg" data-md="images/card-coloured-image-4.jpg" data-sm="images/card-coloured-image-4.jpg" alt="" class="blurryload">
                        </div>
                        <div class="card__colored card__colored--green">
