...
@section('content')
                    ...
                    <div class="col-md-10 col-lg-8 col-md-offset-1 col-lg-offset-2">
                        <div class="d-i-block">
                            ...
                            <ul class="breadcrumbs">
                                ...
                                <a href="{{ asset('/public-places') }}" class="label">{!! $page->{"name_$locale"} !!}</a>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-2">
                <ul class="buttons btn_padding">
                    ...
                    <li><a href="{{asset('/public-places')}}" class="list">{!! $page->{"name_$locale"} !!}</a></li>
                </ul>
            </div>
    ...
    <div class="container">
        <h2 class="row section__title col-md-10">@lang('voyager.generic.best_known_public')</h2>
    </div>
    <div class="container">
        <div class="row">
                    ...
                    <a href="/public-places/{{ $place->slug }}" class="card ">
                        ...
                        <div class="card__overlay">
                            <div class="card__description">
                                <div class="card__type label label--violet">@lang('voyager.generic.public_places')</div>

                                <div class="card__title">{!! $place->{"name_$locale"} !!}</div>
                                <ul class="card__info">
                                    <li><i class="fa fa-map-marker" aria-hidden="true"></i>{!! $place->{"address_$locale"} !!}
                                    </li>
