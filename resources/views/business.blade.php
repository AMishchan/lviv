...
@section('content')
    ...
    <section>
        <div class="container">
            <section class="section pb-3">
                <h2 class="section__title">Події</h2>
                <div class="row">
                    <div class="col-sm-6">
                        <div class="card card--info">
                            <div class="text-center card--info__content">
                                ...
                                <p class="text-secondary">Філіжанка львівської кави – це не лише горнятко чорного
                                    запашною напою, а й дух самого старого Львова, його душа і гордість, історія та
                                    віковічні традиції, які знову і знову оживають з кожним ковтком.</p>
                        ...
                        <a href="#" class="card ">
                            ...
                            <div class="card__overlay">
                                <div class="card__description card__description--short">
                                    ...
                                    <div class="card__title">Львів готується до міжнародного дня кави та складає
                                        пам'ятку кавомана
                                    </div>
                                </div>
                            </div>
        ...
        <div class="container">
            <div class="row mb-4">
                <div class="col-md-10 col-lg-8 col-md-offset-1 col-lg-offset-2">
                    ...
                    <div class="mb-1 text-content text-secondary">
                        <p>Якщо ви завітали до Львова на довший час, то майте на увазі, що існують різноманітні
                            комбінації проїздних карток терміном на місяць чи більше
                            <br><br>Увага! Львів став першим містом в Україні, де запроваджено безготівкову
                            систему розрахунку в електротранспорті міста. З 16 лютого 2017 р. у всіх львівських трамваях
                            та тролейбусах, пасажири матимуть змогу оплатити проїзд через спеціальний QR код – електронну програму
                            для купівлі та компостирування квитка, яку ініціювали
                            та розробили ЛКП «Львівелектротранс» у співпраці із «Приватбанк».</p>
                    </div>
                </div>
            </div>
        </div>
