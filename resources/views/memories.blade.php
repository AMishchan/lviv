...
@section('content')
                    ...
                    <div class="col-md-10 col-lg-8 col-md-offset-1 col-lg-offset-2">
                        <div class="d-i-block">
                            ...
                            <ul class="breadcrumbs">
                                ...
                                <a href="{{ asset('/memories') }}" class="label">{!! $page->{"name_$locale"} !!}</a>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-2">
                <ul class="buttons btn_padding">
                    ...
                    <li><a href="{{asset('/memories')}}" class="list">{!! $page->{"name_$locale"} !!}</a></li>
                </ul>
            </div>
    ...
    <div class="container">
        <h2 class="row section__title col-md-10">@lang('voyager.generic.best_known_memories')</h2>
    </div>
    <div class="container">
        <div class="row">
            @foreach($memories as $memory)
                <div class="col-sm-6 col-md-4">
                    <a href="/memories/{{ $memory->slug }}" class="card ">
                        <div class="card__img">
                            <img src="{{Voyager::image($memory->photo1)}}" data-lg="images/card-image-1.jpg"
                                 data-md="images/card-image-1.jpg" data-sm="images/card-image-1.jpg" alt=""
                                 class="blurryload">
                        </div>
                        <div class="card__overlay">
                            <div class="card__description">
                                <div class="card__type label label--violet">@lang('voyager.generic.memories')</div>

                                <div class="card__title">{!!$memory->{"name_$locale"}!!}</div>
                                <ul class="card__info">
                                    <li><i class="fa fa-map-marker" aria-hidden="true"></i>{!!$memory->{"address_$locale"}!!}
                                    </li>
