...
@section('content')
    ...
    <div class="container">
        <h2 class="row section__title col-md-10">@lang('voyager.generic.best_known_parks')</h2>
    </div>
    <div class="container">
        <div class="row">
                    ...
                    <a href="/parks/{{ $park->slug }}" class="card ">
                        ...
                        <div class="card__overlay">
                            <div class="card__description">
                                <div class="card__type label label--violet">@lang('voyager.generic.parks')</div>

                                <div class="card__title">{!!$park->{"name_$locale"}!!}</div>
                                <ul class="card__info">
                                    <li><i class="fa fa-map-marker" aria-hidden="true"></i>{!!$park->{"address_$locale"}!!}
                                    </li>
