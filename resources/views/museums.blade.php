...
@section('content')
                    ...
                    <div class="col-md-10 col-lg-8 col-md-offset-1 col-lg-offset-2">
                        <div class="d-i-block">
                            ...
                            <ul class="breadcrumbs">
                                ...
                                <a href="{{ asset('/museums') }}" class="label">{!! $page->{"name_$locale"} !!}</a>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-2">
                <ul class="buttons btn_padding">
                    ...
                    <li><a href="{{asset('/museums')}}" class="list">{!! $page->{"name_$locale"} !!}</a></li>
                </ul>
            </div>
                ...
                <div class="col-md-10">
                    <div class="col-md-10">
                        <div class="text-secondary text-content">
                            <p class="mb-4">{!! $page->{"title_$locale"} !!}
    ...
    <div class="container">
        <h2 class="row section__title col-md-10">@lang('voyager.generic.best_known_museums')</h2>
    </div>
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-6 col-md-4">
                <a href="/museums/{{ $museum->slug }}" class="card ">
                    ...
                    <div class="card__overlay">
                        <div class="card__description card__description--height">
                            <div class="card__type label label--violet">@lang('voyager.generic.museums')</div>

                            <div class="card__title">{!!$museum->{"name_$locale"} !!}</div>
                            <ul class="card__info">
                                <li><i class="fa fa-map-marker" aria-hidden="true">{!!$museum->{"address_$locale"}!!}</i>
                                </li>
