            ...
            <div class="cover__content">
                <div class="row">
                    <div class="col-md-10 col-lg-8 col-md-offset-1 col-lg-offset-2">
                        <div class="d-i-block">
                            <div class="label label--blue mb-1">{{$teatr->type}}</div>
                            <h1 class="cover__title">{{$teatr->name}}</h1>
                            <ul class="breadcrumbs">
                                <a href="/teatrs" class="label">Театри та Філармонії/</a>
                                <a href="#" class="label">{{$teatr->name}}</a>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="row ">
            ...
            <div class="col-md-9 col-md-offset-1 ">
                <ul class="buttons">
                    ...
                    <li><a href="#" class="list">Театри та Філармонії</a></li>
