...
@section('content')
    ...
    <div class="cover" style="background-image: url({{Voyager::image($memory->banner_photo)}});">
        <div class="container">
            <div class="cover__content">
                <div class="row">
                    <div class="col-md-9 col-lg-8 col-md-offset-3 col-lg-offset-2">
                        <div class="d-i-block">
                            <div class="label label--blue mb-1">@lang('voyager.generic.memories')</div>
                            <h1 class="cover__title">{!!$memory->{"name_$locale"}!!}</h1>
                            <ul class="breadcrumbs">
                                <a href="/memories" class="label">@lang('voyager.generic.memories')/</a>
                                <a href="#" class="label">{!!$memory->{"name_$locale"}!!}</a>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-md-9 pad">
                <ul class="buttons">
                    ...
                    <li><a href="#" class="list">@lang('voyager.generic.memories')</a></li>
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-md-offset-2">
                <div class="images_gallery">
                    <img style="width: 100%" class="mySlides" src="{{Voyager::image($memory->photo1)}}">
                    <img style="width: 100%" class="mySlides" src="{{Voyager::image($memory->photo2)}}">
                    <img style="width: 100%" class="mySlides" src="{{Voyager::image($memory->photo3)}}">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-2 first_block_container">
                ...
                <div class="second_block col-md-5">
                    <p>Квітень</p>
                    <p>2017</p>
                </div>
            </div>
