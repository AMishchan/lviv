            ...
            <div class="cover__content">
                <div class="row">
                    <div class="col-md-9 col-lg-8 col-md-offset-3 col-lg-offset-2">
                        <div class="d-i-block">
                            <div class="label label--blue mb-1">Памʼятки</div>
                            <h1 class="cover__title">{{$memory->name}}</h1>
                            <ul class="breadcrumbs">
                                <a href="/memories" class="label">Памʼятки/</a>
                                <a href="#" class="label">{{$memory->name}}</a>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="row ">
            ...
            <div class="col-md-9 col-md-offset-1 ">
                <ul class="buttons">
                    ...
                    <li><a href="#" class="list">Памʼятки</a></li>
