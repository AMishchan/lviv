...
@section('content')
            ...
            <div class="cover__content">
                <div class="row">
                    <div class="col-md-10 col-lg-8 col-md-offset-1 col-lg-offset-2">
                        <div class="d-i-block">
                            <h1 class="cover__title">Навколо Львова</h1>
                            <ul class="breadcrumbs">
                                <a href="/" class="label">Головна/</a>
                                <a href="#" class="label">Що робити/</a>
                                <a href="{{ asset('/around_lviv') }}" class="label">Навколо Львова</a>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-2">
                <ul class="buttons btn_padding">
                    ...
                    <li><a href="{{asset('/around_lviv')}}" class="list">Навколо Львова</a></li>
                </ul>
            </div>
    ...
    <div class="container">
        <h2 class="row section__title col-md-10">Найвідоміші місця навколо Львова</h2>
    </div>
    <div class="container">
        <div class="row">
                    ...
                    <a href="/around_lviv/{{ $around->slug }}" class="card ">
                        ...
                        <div class="card__overlay">
                            <div class="card__description card__description--short">
                                <div class="card__type label label--violet">Навколо Львова</div>

                                <div class="card__title">{{$around->name}}</div>
                                <ul class="card__info">
                                    <li><i class="fa fa-map-marker" aria-hidden="true"></i>{{$around->address}}
                                    </li>
