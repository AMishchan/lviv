...
return [
    ...
    'generic' => [
        ...
        'hide'                   => 'сховати',
        'main'                   => 'Головна',
        'best_known_round'       => 'Найвідоміші місця навколо Львова',
        'interest'               => 'Вас це може зацікавити',
        'museums'                => 'Музеї',
        'best_known_museums'     => 'Найвідоміші музеї Львова',
        'shedule'                => 'Графік работи',
        'price'                  => 'Вартість',
        'articles'               => 'Цікаві статті',
        'excursions'             => 'Екскурсії',
        'order'                  => 'Замовити екскурсію',
        'visite'                 => 'Відвідати сторінку',
        'profiles'               => 'Профіль',
        'parks'                  => 'Парки',
        'best_known_parks'       => 'Найвідоміші парки Львова',
        'teatrs'                 => 'Театри та Філармонії',
        'best_known_teatrs'      => 'Найвідоміші Театри та Філармонії Львова',
        'memories'               => 'Памʼятки',
        'best_known_memories'    => 'Найвідоміші Памʼятки Львова',
        'best_known_public'      => 'Найвідоміші Громадські місця Львова',
        'guide'                  => 'Гід',
        'excursion'              => 'Екскурсії',
        'order_ex'               => 'Замовити екскурсію',
        'guide_page'             => 'Сторінка гіда',
        'tours'                  => 'Інші екскурсії гіда',
        'ex_guide'               => 'Екскурсії від гіда',
        'tour'                   => 'Тури',
        'best_known_attractions' => 'Найвідоміші Аттракції Львова',
        'attractions'            => 'Аттракції',
        'news'                   => 'Новини',
        'news_city'              => 'Новини міста'
    ],
